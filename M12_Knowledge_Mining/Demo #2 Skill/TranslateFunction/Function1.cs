...
namespace TranslateFunction
{
    public static class Translate
    {
        ...
        static string CognitiveServicesTokenUri = "https://alextranslatorapi.cognitiveservices.azure.com/sts/v1.0/issuetoken";
        static string SubscriptionKey = "26a2baff60ca4263bfbcbf3229cbe021";
        static string token;
